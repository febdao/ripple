<template>
  <div class="rpl-search-results">
    ...
    <div class="rpl-search-results__sort">
      <slot name="sort"></slot>
    </div>
    <rpl-row row-gutter class="rpl-search-results__main" v-if="searchResults && !errorMsg">
      <slot name="results" :searchResults="searchResults"></slot>
      <div v-if="searchResults.length === 0" class="rpl-search-results__no-results-msg">
        <slot name="noresults">{{ noResultsMsg }}</slot>
      </div>
